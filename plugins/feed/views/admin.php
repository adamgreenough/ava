...
<head>
    ...
    <title>RSS Feeds - Ava Admin</title>
...
<div class="layout">
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="nav">
            ...
            <a href="<?= $admin_url ?>/<?= htmlspecialchars($slug) ?>" class="nav-item<?= $slug === 'feeds' ? ' active' : '' ?>">
    ...
    <main class="main">
        ...
        <div class="header">
            ...
            <div class="header-actions">
                <a href="<?= htmlspecialchars($baseUrl) ?>/feed.xml" target="_blank" class="btn btn-primary btn-sm">
